# oci-cloudera
This module deploys a cluster of arbitrary size on [Oracle Cloud Infrastructure](https://cloud.oracle.com/en_US/iaas){:target="_blank"} using [Cloudera Enterprise Data Hub](https://www.cloudera.com/products/enterprise-data-hub.html){:target="_blank"} v6 and Cloudera Manager v6.1.
