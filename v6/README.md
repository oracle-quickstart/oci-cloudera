...
This automation now defaults to using a local KDC deployed on the Cloudera Manager instance for secure cluster operation.  Please read the scripts [README](../blob/master/v6/scripts/README.md) for information regarding how to set these parameters prior to deployment.
